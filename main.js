...
var HttpRequestError = class extends Error {
  ...
  constructor(message, opts) {
    ...
    if (opts?.responseData !== void 0) this.responseData = opts.responseData;
    if (opts?.code !== void 0) this.code = opts.code;
  }
};
function isHttpRequestError(err) {
...
function syncHttpRequest(params) {
  ...
  if (contentType !== void 0 && contentType !== "") req.contentType = contentType;
  return (async () => {
    let raw;
    try {
      raw = await withTimeout((0, import_obsidian.requestUrl)(req), timeoutMs);
    } catch (e) {
...
function buildMultipartFormData(fields, fileField) {
  ...
  for (const [k, v] of Object.entries(fields)) {
    push(
      `--${boundary}\r
Content-Disposition: form-data; name="${esc(k)}"\r
\r
${v}\r
`
    );
  ...
  push(
    `--${boundary}\r
Content-Disposition: form-data; name="${esc(fileField.fieldName)}"; filename="${esc(fileField.filename)}"\r
Content-Type: ${fileField.contentType}\r
\r
`
  );
...
function appendQueryUrl(base, params) {
...
function pathUnderVaultConfig(normalizedPath, vaultConfigDir) {
  const cfg = normalizeVaultPath(vaultConfigDir);
  if (!cfg) return false;
  const p = normalizedPath;
  return p === cfg || p.startsWith(`${cfg}/`);
}
function shouldSync(filePath, vaultConfigDir) {
...
function parseRemoteFilesItems(parsed, vaultConfigDir) {
...
function coerceApiStringField(v) {
  if (typeof v === "string") return v.trim();
  if (typeof v === "number" && Number.isFinite(v)) return String(v);
  if (isPlainObjectRecord(v)) {
    for (const key of ["name", "label", "value", "text", "displayName"]) {
      const inner = v[key];
...
function parsePartialSettingsData(raw) {
...
var HailySyncSettingTab = class extends import_obsidian2.PluginSettingTab {
  plugin;
  maskedBindingText = "";
  ...
  async runResetBindingAfterConfirm() {
    ...
    if (ok) {
      ...
      new import_obsidian2.Notice("\u64CD\u4F5C\u5DF2\u5B8C\u6210");
    } else {
...
\u786E\u5B9A\u79FB\u9664\u300C${label}\u300D\u5417\uFF1F`,
  ...
  display() {
    ...
    new import_obsidian2.Setting(bindingBlock).setName("\u8BBE\u5907\u7ED1\u5B9A\u7801\uFF08\u7528\u4E8E\u8FDE\u63A5\u65B0\u8BBE\u5907\uFF0C\u8BF7\u59A5\u5584\u4FDD\u5B58\uFF09").addButton(
    ...
    new import_obsidian2.Setting(bindNewBlock).setName("\u7ED1\u5B9A\u65B0\u8BBE\u5907").setDesc("\u8F93\u5165\u8BBE\u5907\u7ED1\u5B9A\u7801\u5373\u53EF\u8FDE\u63A5").addText((text) => {
    ...
    new import_obsidian2.Setting(devBlock).setName("\u5DF2\u7ED1\u5B9A\u8BBE\u5907").setDesc("\u5F53\u524D\u8BBE\u5907\u4E0D\u53EF\u79FB\u9664").addButton((btn) => {
    ...
    new import_obsidian2.Setting(autoSyncCard).setName("\u81EA\u52A8\u540C\u6B65\uFF08\u63A8\u8350\u5F00\u542F\uFF09").addToggle(
    ...
    new import_obsidian2.Setting(manualSyncCard).setName("\u624B\u52A8\u540C\u6B65").setDesc("\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u540C\u6B65").addButton((btn) => {
      btn.setButtonText("\u7ACB\u5373\u540C\u6B65");
      btn.onClick(() => {
        void (async () => {
          if (this.plugin.isSyncing) {
            new import_obsidian2.Notice("\u8BF7\u7A0D\u5019\uFF0C\u4E0A\u4E00\u540C\u6B65\u5C1A\u672A\u7ED3\u675F");
            return;
          }
    ...
    new import_obsidian2.Setting(advBody).setName("\u670D\u52A1\u5668\u5730\u5740").setDesc("\u7559\u7A7A\u5C06\u4F7F\u7528\u9ED8\u8BA4\u670D\u52A1\u5668\n\u4EC5\u5728\u9700\u8981\u65F6\u4FEE\u6539").addText(
...
var ObsidianSyncPlugin = class extends import_obsidian2.Plugin {
  ...
  async wipeVaultKeyLocal() {
    ...
    try {
      ...
      if (exists instanceof import_obsidian2.TFile) await this.app.fileManager.trashFile(exists);
    } catch {
    }
  }
  ...
  async ensureDeviceIdentity() {
    ...
    try {
      ...
      if (isPlainObjectRecord(parsed) && typeof parsed.user_id === "string" && parsed.user_id.trim() !== "" && !parsed.device_id) {
        ...
        new import_obsidian2.Notice("\u8BF7\u5148\u8F93\u5165\u8BBE\u5907\u7ED1\u5B9A\u7801", 12e3);
        return;
      }
    } catch {
    }
  ...
  async callApiInit() {
    ...
    if (!server) {
      this.connectionState = "awaiting_bind";
      new import_obsidian2.Notice("\u8FDE\u63A5\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC");
      return;
    }
    try {
      const res = await syncHttpRequest({
      ...
      if (!isPlainObjectRecord(payload)) {
        this.connectionState = "awaiting_bind";
        new import_obsidian2.Notice("\u540C\u6B65\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5");
        return;
      }
      ...
      try {
        ...
        new import_obsidian2.Notice("\u540C\u6B65\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5", 12e3);
        return;
      }
    } catch (e) {
      this.connectionState = "awaiting_bind";
  ...
  async fetchBindingCodeRaw() {
    ...
    try {
      ...
      if (isDeviceRevokedError(e)) {
        ...
        new import_obsidian2.Notice("\u8BF7\u91CD\u65B0\u8F93\u5165\u8BBE\u5907\u7ED1\u5B9A\u7801\u4EE5\u6062\u590D\u8FDE\u63A5", 12e3);
        return null;
      }
      if (isNetworkError(e)) {
        new import_obsidian2.Notice("\u8FDE\u63A5\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC");
  ...
  async bindWithCode(raw) {
    const code = raw.trim();
    if (!code) {
      new import_obsidian2.Notice("\u8BF7\u5148\u8F93\u5165\u8BBE\u5907\u7ED1\u5B9A\u7801");
      return false;
    }
    const server = this.baseUrl;
    if (!server) {
      new import_obsidian2.Notice("\u8FDE\u63A5\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC", 6e3);
      return false;
    }
    try {
      const res = await syncHttpRequest({
      ...
      try {
        ...
        new import_obsidian2.Notice("\u8BBE\u5907\u7ED1\u5B9A\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u7ED1\u5B9A\u7801\u6B63\u786E");
        return false;
      }
      if (!isPlainObjectRecord(data)) {
        new import_obsidian2.Notice("\u8BBE\u5907\u7ED1\u5B9A\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u7ED1\u5B9A\u7801\u6B63\u786E");
      ...
      if (typeof uid !== "string" || !uid.trim() || typeof did !== "string" || !did.trim()) {
        new import_obsidian2.Notice("\u8BBE\u5907\u7ED1\u5B9A\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u7ED1\u5B9A\u7801\u6B63\u786E", 6e3);
        return false;
      }
      if (typeof kekSalt !== "string" || typeof kekDv !== "number" || typeof vkv !== "number" || envelope == null || !isPlainObjectRecord(envelope)) {
        new import_obsidian2.Notice("\u8BBE\u5907\u7ED1\u5B9A\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u7ED1\u5B9A\u7801\u6B63\u786E", 8e3);
        return false;
      }
      try {
        ...
        new import_obsidian2.Notice("\u8BBE\u5907\u7ED1\u5B9A\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u7ED1\u5B9A\u7801\u6B63\u786E", 12e3);
        await this.wipeVaultKeyLocal();
        return false;
      }
      await this.persistFullIdentity(uid.trim(), did.trim(), code.trim());
      new import_obsidian2.Notice("\u8BBE\u5907\u8FDE\u63A5\u6210\u529F\uFF0C\u5F00\u59CB\u540C\u6B65");
      void this.syncNow();
      return true;
    } catch (e) {
      if (isDeviceRevokedError(e)) {
  ...
  listLocalFiles() {
    ...
    return this.app.vault.getMarkdownFiles().map((f) => normalizeVaultPath(f.path)).filter((p) => shouldSync(p, cfg));
  }
  ...
  async uploadFile(filePath, meta) {
    ...
    try {
      ...
      let d;
      try {
        d = JSON.parse(uploadResRaw.text);
      } catch {
  ...
  async postDeleteRemote(filePath) {
    ...
    if (ok !== true || rp !== normalized || typeof ua !== "number") {
      throw new Error("\u5220\u9664\u54CD\u5E94\u4E0D\u7B26\u5408\u51BB\u7ED3\u534F\u8BAE\uFF08success / relative_path / updated_at\uFF09");
    }
  }
    ...
    try {
      ...
      try {
        ...
        if (e instanceof Error && e.message === "E2EE_NEED_BINDING_CODE") {
          new import_obsidian2.Notice("\u8BBE\u5907\u7ED1\u5B9A\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u7ED1\u5B9A\u7801\u6B63\u786E", 15e3);
      ...
      new import_obsidian2.Notice("\u6B63\u5728\u540C\u6B65\u2026");
      ...
      try {
        ...
        if (isNetworkError(err)) {
          ...
          new import_obsidian2.Notice("\u8FDE\u63A5\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC", 8e3);
        } else {
          const detail = formatSyncError(err);
          this.lastSyncError = `\u65E0\u6CD5\u83B7\u53D6\u7B14\u8BB0\u5217\u8868\uFF1A${detail}`;
          new import_obsidian2.Notice("\u540C\u6B65\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5", 8e3);
        }
        return;
      }
      ...
      for (const path of sortedPaths) {
        ...
        const localExists = abstract instanceof import_obsidian2.TFile;
      ...
      if (stepErrors.length > 0) {
        ...
        this.setSyncStatusFailed();
        new import_obsidian2.Notice("\u540C\u6B65\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5", 1e4);
        return;
      }
      this.lastSyncAt = Date.now();
      this.lastSyncError = null;
      this.setSyncStatusSuccess();
      new import_obsidian2.Notice("\u540C\u6B65\u5B8C\u6210");
    } catch (e) {
      this.setSyncStatusFailed();
      if (isNetworkError(e)) {
        this.lastSyncError = "\u7F51\u7EDC\u5F02\u5E38\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5";
