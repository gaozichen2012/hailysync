...
\u786E\u5B9A\u79FB\u9664\u300C${d.device_name || "\u8BE5\u8BBE\u5907"}\u300D\u5417\uFF1F`
  ...
  display() {
    ...
    new import_obsidian.Setting(autoSyncCard).setName("\u81EA\u52A8\u540C\u6B65\uFF08\u63A8\u8350\u5F00\u542F\uFF09").addToggle(
    ...
    new import_obsidian.Setting(manualSyncCard).setName("\u624B\u52A8\u540C\u6B65").setDesc("\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u540C\u6B65").addButton((btn) => {
